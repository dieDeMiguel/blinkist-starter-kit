...
const SidebarFooter = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn("border-t border-gray-200 py-4", className)} {...props} />
  ),
)
SidebarFooter.displayName = "SidebarFooter"

const SidebarNav = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => <nav ref={ref} className={cn("", className)} {...props} />,
)
...
const SidebarNavItem = React.forwardRef<HTMLLIElement, SidebarNavItemProps>(({ className, active, ...props }, ref) => (
  <li
    ref={ref}
    className={cn(
      "relative font-sans",
